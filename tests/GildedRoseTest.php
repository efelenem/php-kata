...
class GildedRoseTest extends TestCase
{
	...
	/** @test */
	function it_updates_normal_items_with_quality_of_0()
	{
	...
	/** @test */
	function it_updates_brie_items_before_sell_date_with_max_quality()
	{
	...
	/** @test */
	function it_updates_brie_items_on_the_sell_date_near_max_quality()
	{
	...
	/** @test */
	function it_updates_brie_items_on_the_sell_date_with_max_quality()
	{
	...
	/** @test */
	function it_updates_brie_items_after_sell_date_with_max_quality()
	{
		$item = GildedRose::of('Aged Brie', 50, -5);
	...
	/** @test */
	function it_updates_backstage_pass_items_long_before_sell_date()
	{
	...
	/** @test */
	function it_updates_backstage_pass_items_on_sell_date()
	{
	...
	/** @test */
	function it_updates_backstage_pass_items_after_sell_date()
	{
		$item = GildedRose::of('Backstage passes to a TAFKAL80ETC concert', 10, -1);
